...
# ============================================================
# Run InfoNCE embedding training on pre-generated synthetic graphs.
#
# Usage:
#   bash embed_from_saved_graph_infonce_array.sh
#
# This script:
...
NUM_STEPS=100000
SAVE_EVERY=1000
BATCH_SIZE=""        # ignored by the Python script for InfoNCE; kept for interface compatibility
LR=0.01
MIN_LR_RATIO=0.01
WARMUP_FRAC=0.05
TEMPERATURE=0.1
...
BASE_SAVE_PATH="/home/kirilb/orcd/pool/TopK/SyntheticEmbeddings/infonce_${INITIALIZATION}_initialization"
...
if [ -z "${SLURM_ARRAY_TASK_ID:-}" ]; then
    ...
    manifest="${MANIFEST_DIR}/embed_infonce_manifest_${timestamp}.txt"
    : > "${manifest}"
